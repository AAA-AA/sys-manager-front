    ...
    <el-dialog title="编辑"
      ...
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="年龄">
          <el-input-number v-model="editForm.age" :min="0" :max="200" :step="1"></el-input-number>
        </el-form-item>
...
<script>
  ...
  import {getUserListPage, removeUser, batchRemoveUser, updateUser, addUser} from '../../api/api';
  ...
  export default {
    ...
    methods: {
      ...
      formatBirthDate: function (row, column) {
        return row.birth.replace("T", " ").substring(0, 10);
      },
      ...
      handleEdit: function (index, row) {
        ...
        this.editForm.birthDate = row.birth.replace("T", " ").substring(0, 10);
        debugger
      },
      //显示新增界面
      handleAdd: function () {
        ...
        this.$refs.editForm.validate((valid) => {
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(() => {
              ...
              para.birthDate = (!para.birthDate || para.birthDate == '') ? '' : util.formatDate.format(new Date(para.birthDate), 'yyyy-MM-dd');
