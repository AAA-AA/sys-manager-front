<template>
	<section>
		...
		<el-table :data="roles" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="key" label="角色key" width="130" sortable>
			</el-table-column>
			<el-table-column prop="desc" label="备注" min-width="180" sortable>
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="角色key">
					<el-input-number v-model="editForm.key" :min="0" :max="200" :step="1"></el-input-number>
				</el-form-item>
